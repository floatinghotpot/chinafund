...
from chinafund.version import __version__
...
setuptools.setup(
    ...
    url = 'https://github.com/floatinghotpot/chinafund',
    download_url = 'https://github.com/floatinghotpot/chinafund',
    ...
    entry_points={'console_scripts': ['chinafund=chinafund.cli:cli_main']},
